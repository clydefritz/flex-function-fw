    ...
    try {
        ...
        thisFlexFuncAdminConfig.flexFunctionAdminRoutes.forEach(adminroute => {
            ...
            if (handler) {
                ...
                console.log(`Admin route registered: ${method.toUpperCase()} ${routePath}, handler: ${adminroute.handler}`);
            } else {
                console.error(`Admin handler for "${adminroute.handler}" not found.`);
            }
        });
